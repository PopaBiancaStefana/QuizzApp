...
public class Statistics {
    ...
    public void makeNetwork(String fileName) {
        ...
        makeSVG(getMutableGraph(getGraph()), fileName);
    }

    public void makeCustomNetwork(Graph<Person, DefaultEdge> graph, String fileName){
        addDomains();
        makeDot(graph);         //OPTIONAL
        makeSVG(getMutableTeamsGraph(graph), fileName);
    }
